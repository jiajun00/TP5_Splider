...
前端通过vue-cli，后端通过Thinkphp5实现数据信息抓取

基于Thinkphp5 +phpQuery 整理的API接口

 + 招聘信息抓取(前程无忧/智联招聘/boss直聘/拉勾网)数据接口
...
```shell
git clone  https://github.com/jiajun00/VUE_TP5_Splider.git
 ...
 **接口地址:**
  ...
  **调用例子:**
      `http://www.xxx.com/index.php/api/Zhihu/zhihu_daily`
 ...
 **接口地址:**
  ...
  **调用例子:**
      `http://www.xxx.com/index.php/api/Zhihu/news?id=9454551`
 ...
 **接口地址:**
  ...
  **调用例子:**
      `http://www.xxx.com/index.php/api/Zhihu/new_comment?id=9454551`
...
说明: 获取招聘信息如 web开发工程师、php等。支持前程无忧、智联招聘、猎聘网、boss直聘
  访问地址：`http://splider.qqxio.cn/#/job`
